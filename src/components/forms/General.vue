			...
			<div class="card card-info">
				...
				<div class="card-body">
					...
					<div class="input-group mb-3">
						<div class="input-group-prepend">
							<span class="input-group-text">
								<font-awesome-icon class="fas" icon="fa-solid fa-envelope" />
							</span>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group-append">
							<span class="input-group-text">
								<font-awesome-icon class="fas" icon="fa-solid fa-check" />
							</span>
						</div>
					</div>
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text">
								<font-awesome-icon class="fas" icon="fa-solid fa-dollar-sign" />
							</span>
						</div>
						<input type="text" class="form-control">
						<div class="input-group-append">
							<div class="input-group-text">
								<font-awesome-icon class="fas" icon="fa-solid fa-ambulance" />
							</div>
						</div>
					</div>
					...
					<form>
						...
						<div class="form-group">
							<label class="col-form-label" for="inputSuccess">
								<font-awesome-icon class="fas" icon="fa-solid fa-check" /> Input with success
							</label>
							<input type="text" class="form-control is-valid" id="inputSuccess" placeholder="Enter ...">
						</div>
						<div class="form-group">
							<label class="col-form-label" for="inputWarning">
								<font-awesome-icon class="fas" icon="fa-solid fa-bell" /> Input with warning
							</label>
							<input type="text" class="form-control is-warning" id="inputWarning" placeholder="Enter ...">
						</div>
						<div class="form-group">
							<label class="col-form-label" for="inputError">
								<font-awesome-icon class="fas" icon="fa-solid fa-times-circle" /> Input with error
							</label>
